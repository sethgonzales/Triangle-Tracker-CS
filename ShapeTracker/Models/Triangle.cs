...
namespace ShapeTracker.Models //models === business logic
{
  public class Triangle
  {
    //field within our Triangle class (variables(known as properties in js))
    private int _side1;
    private int _side2;
    private int _side3;
    private static List<Triangle> _instances = new List<Triangle> { };

    public Triangle(int length1, int length2, int length3) //constructor method that executes when a new instance of our Triangle class is called
    {
      _side1 = length1;
      _side2 = length2;
      _side3 = length3;
